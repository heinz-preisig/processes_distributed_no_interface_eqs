...
\endlastfoot
    ...
    \begin{lay}macroscopic\end{lay} \\
        \hyperlink{"v:244"}{ 143 }\hypertarget{"e:143"}{  } &
    \begin{eq}{\_mv\_I}{_{I}} := {{F^{source}}}{_{N, I}} \stackrel{N}{\star} {{\bar{T}}}{_{N}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
    \begin{lay}macroscopic --> control\end{lay} \\
        \hyperlink{"v:245"}{ 144 }\hypertarget{"e:144"}{  } &
    \begin{eq}{T_meas}{_{N, p}} := \left({{F^{sink}}}{_{N, I}} \, . \, {\_mv\_I}{_{I}}\right) \stackrel{I}{\star} {{S}}{_{I, p}}\end{eq} &
    \begin{lay}interface equation\end{lay} &
